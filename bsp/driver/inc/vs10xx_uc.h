...
/** @addtogroup BBSP_DRV_ACODEC_PRIVATE
 * @{
 */
/*
  ...
  v2.00 2017-02-06 LD  Added compiler directives for VSx
...
#if defined(VS1063) || defined(VS1053) || defined(VS1033) || defined(VS1003) || defined(VS1011)
...
#define SM_DIFF_B             0
#if defined(VS1063) || defined(VS1053) || defined(VS1033) || defined(VS1011)
...
#elif defined(VS1033) || defined(VS1003) || defined(VS1011)
#define SM_OUTOFWAV_B         3 /* VS1033, VS1003, VS1011 */
#elif defined(VS1103)
#define SM_OUTOFMIDI_B        3 /* VS1103 */
#endif
#if defined(VS1053) || defined(VS1033)
#define SM_EARSPEAKER_LO_B    4 /* VS1053, VS1033 */
#elif defined(VS1003) || defined(VS1103)
#define SM_PDOWN_B            4 /* VS1003, VS1103 */
#endif
#define SM_TESTS_B            5
#if defined(VS1053) || defined(VS1033) || defined(VS1003) || defined(VS1011)
...
#elif defined(VS1033) || defined(VS1003) || defined(VS1103) || defined(VS1011)
...
/* SCI_CLOCKF bits */
#if defined(VS1063) || defined(VS1053) || defined(VS1033) || defined(VS1103) || defined(VS1003)
...
#if defined(VS1063) || defined(VS1053) || defined(VS1033) || defined(VS1003) || defined(VS1103)
...
#if defined(VS1003) || defined(VS1033)
...
#if defined(VS1053) || defined(VS1063)
